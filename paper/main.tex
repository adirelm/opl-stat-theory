...
$0.60$ (Fisher-transform CI $[0.600,0.603]$; Spearman $0.58$); it is lower for women. The message is not that women
...
no-skill baseline, i.e.\ the below-limit share; balanced accuracy $0.53$). The signal is weak,
...
a parametric Welch test agrees, $|t|=128$; rank-biserial $-0.20$), consistent with (though not proof of) an effect of
...
of the two-sample comparison above. \textbf{Equipment.} Dots differs across
...
highest (median Dots $401$ vs.\ $328$ raw). \textbf{Extreme values.} A GEV fit to equal-size block maxima of recent
...
trend.} Median Dots drifted down over 2000--2024 (Spearman $\rho=-0.54$); one
...
measurements, not effect size. \textbf{Residual normality.} The H3 (all-row fit) residuals are left-skewed
...
the windows $(c-0.5,c]$ and $(c,c+0.5]$~kg.
