...
IPF men's class limit (de-heaped $\log(\text{below}/\text{above})=+1.92$ at 83~kg); a
...
the bar and strategic mass below the limit, while the scaling and extreme-value
analyses find no evidence of a population strength ceiling. Code and data:
