...
and placebos show no bunching-direction false positives. (iii)~\emph{Allometry}: strength scales with
...
total ($R^2=0.70$, random forest, leakage-safe grouped CV). These choices leave measurable patterns in the data. Code and data:
...
$0.60$ (Fisher-transform CI $[0.60,0.60]$; Spearman $0.58$); it is lower for women. The message is not that women
...
$120{+}$ class shows the weakest bunching, consistent with weaker pressure at
that unbounded boundary; the
