...
\begin{IEEEkeywords}
density discontinuity, bunching, allometric scaling,
likelihood-ratio test, extreme-value theory, large-sample inference, powerlifting
\end{IEEEkeywords}
...
estimates the men-minus-women slope gap at $+0.24$ (HC3 95\% CI $[0.23,0.25]$, $p\!\ll\!10^{-3}$). The gap also \emph{grows} on the common bodyweight support ($0.84$ men vs.\ $0.38$
...
Dots score prefers one (Fig.~\ref{fig:struct}). \textbf{Tested vs.\ untested.} Untested competitions show
