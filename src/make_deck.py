#!/usr/bin/env python3
"""
בונה מצגת אמצע (PPTX נייטיב) לפרויקט הסוף - OpenPowerlifting.
RTL עברי מוגדר ברמת-פסקה (a:pPr rtl="1"). פותחים/עורכים/מציגים ב-Google Slides.
גרסה מעודכנת אחרי ביקורת 20 סוכנים + codex + gemini.
"""
...
prs.save(out)
print("נשמר:", out, "|", len(list(prs.slides)), "שקפים")
