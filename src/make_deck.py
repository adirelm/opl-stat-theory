...
fig_slide("תוצאות ראשוניות (2): חיתוך-משקל",
          ...
          sub='סף אמיתי 83 ק"ג: הצטברות · בקרה 91 ק"ג: אין הצטברות')
...
line(textbox(s, LEFT, 1.6, BODYW, 1.35),
     ...
     'אבל אמידת-השיפוע תקפה אסימפטוטית במדגם ענק (במיוחד עם SE חסין/מקובץ לפי מתחרה), ומבחן-נורמליות פורמלי דוחה ב-n ענק כל סטייה זעירה '
