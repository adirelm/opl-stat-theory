...
fig_slide("תוצאות ראשוניות (2): חיתוך-משקל",
          'מתחת לסף 83 ק"ג (מחלקות IPF+USAPL, גברים) הצטברות חדה: יחס-לוג לאחר ניקוי-עיגול (כבר הוחל) +1.92 ± 0.04, כלומר פי ~6.8 ממש-מתחת לעומת ממש-מעל. בבקרה שאינה סף (91 ק"ג): −0.21 ± 0.03. עקבי עם חיתוך-משקל; אישוש פורמלי (McCrary) בהמשך.',
          "fig_bunching.png", 9.8/4.3, 11.2)

# ---- Slide 8: results H3 (allometry) ----
fig_slide("תוצאות ראשוניות (3): קנה-מידה אלומטרי",
          'קנה-המידה שונה בין המינים: b≈0.72 (R²=0.36) גברים / 0.49 (R²=0.19) נשים, מול 2/3 האיזומטרי (רווח-סמך ל-b צר מאוד, ±<0.01, בגלל n עצום). ייבדק פורמלית במבחן Wald (SE חסין); b<0.5 לנשים הוא אומדן ראשוני, ייתכן אפקט טווח-משקל.',
