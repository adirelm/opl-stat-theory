...
content("נתוני המחקר", [
    ...
    "אתגר עיקרי: אותו מתחרה מופיע בכמה תחרויות, אז במבחנים הפורמליים ניקח שורה אחת לכל מתחרה. שומרים גרסת-נתונים קבועה לשחזור.",
])
...
content("שיטות החקר", [
    ...
    "H3 (כוח מול משקל): רגרסיה שבודקת אם קנה-המידה שונה מ-2/3 ובין המינים (מבחן Wald).",
    "H4 (לעבודה הסופית): מודל ניבוי-כוח, רגרסיה + Random Forest + סיווג, שנבדק על נתונים חדשים.",
    'כי המדגם ענק (כמעט 4 מיליון, עוצמה גבוהה), כמעט הכל יוצא "מובהק", אז מדגישים גודל-אפקט ורווח-סמך, לא p. תיקונים לבדיקות-מרובות: Bonferroni/Holm/Šidák (FWER) + BH (FDR).',
], lead_size=20)
...
fig_slide("תוצאות ראשוניות (2): חיתוך-משקל",
          'פי כ-6.8 יותר מתחרים נשקלים בדיוק מתחת לסף 83 ק"ג מאשר מעליו (גברים, IPF+USAPL). במספרים: יחס-לוג ‎+1.92 ± 0.04‎, גם אחרי ניקוי מספרים-עגולים. בבקרה שאינה סף (91 ק"ג) אין הצטברות כזו: ‎−0.21 ± 0.03‎. עקבי עם חיתוך-משקל; אישוש פורמלי (McCrary) בהמשך.',
